...
function initRoiSimulator() {
    ...
    function calculate() {
        ...
        if (ctaBtn) {
            ...
            const msg = encodeURIComponent(`Olá Jefferson! Simulei o canal próprio do Botequim Pantera no Onira.fly com faturamento de ${formattedRev} e ${migrationPercent}% no canal próprio. Quero garantir os ${formattedSav}/mês de margem limpa no meu caixa!`);
...
function initHeroTicker() {
    ...
    const casesList = [
        { key: 'boteco', domain: 'botequimpantera.com.br', badge: '🍺 Boteco & Baurus • ⚡ 0.35s', img: 'assets/screenshots/botequim_mobile.jpg' },
